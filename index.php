...
<title>Odhiambo Atieno | Exam Portal </title>
...
?>
<script>
function validateForm() {var y = document.forms["form"]["name"].value;	var letters = /^[A-Za-z]+$/;if (y == null || y == "") {alert("You must enter your name.");return false;}var z =document.forms["form"]["college"].value;if (z == null || z == "") {alert("School Name must be filled out.");return false;}var x = document.forms["form"]["email"].value;var atpos = x.indexOf("@");
var dotpos = x.lastIndexOf(".");if (atpos<1 || dotpos<atpos+2 || dotpos+2>=x.length) {alert("Not a valid e-mail address.");return false;}var a = document.forms["form"]["password"].value;if(a == null || a == ""){alert("Password must be filled out");return false;}if(a.length<5 || a.length>30){alert("Passwords must be between 5 to 30 characters long.");return false;}
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="college" name="college" placeholder="Enter your School name" class="form-control input-md" type="text">
...
<a href="https://seentechs.com/" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/seentechs.png" width=100 height=100 alt="Odhiambo Atieno" class="img-rounded">
		 </div>
		 <div class="col-md-5">
